...
param modelServiceAudience = readEnvironmentVariable(
  'CLAIMGUARD_AZURE_MODEL_SERVICE_AUDIENCE'
)

param modelDeploymentId = 'claimguard-claim-fraud-ensemble:1.1.0'

param modelPseudonymizationKey = readEnvironmentVariable(
  'CLAIMGUARD_AZURE_MODEL_PSEUDONYMIZATION_KEY'
)

param reportWorkerImage = readEnvironmentVariable(
  'CLAIMGUARD_AZURE_REPORT_WORKER_IMAGE'
)
