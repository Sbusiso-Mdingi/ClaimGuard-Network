...
function WorkspaceBrand() {
  return (
    <div className="flex items-center gap-3">
      ...
      <div><p className="font-display text-base font-semibold">Sequrin</p><p className="font-data text-[10px] uppercase tracking-[0.18em] text-muted-foreground">Scheme operations</p></div>
    </div>
  );
}
