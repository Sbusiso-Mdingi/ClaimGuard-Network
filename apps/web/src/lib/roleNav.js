  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        capabilities: ["tenants.manage", "platform_health.view", "platform_releases.view", "platform_releases.request", "platform_releases.approve", "platform_administrators.manage"],
        capabilityMode: "any",
        end: true,
      },
      {
        key: "platform-schemes",
        to: "/admin/platform/schemes",
        label: "Schemes & Provisioning",
        capabilities: ["tenants.manage"],
      },
      {
        key: "platform-integrations",
        to: "/admin/platform/integrations",
        label: "Claims Integrations",
        capabilities: ["tenants.manage"],
      },
      {
        key: "platform-releases",
        to: "/admin/platform/releases",
        label: "Releases & Promotions",
        capabilities: ["platform_releases.view", "platform_releases.request", "platform_releases.approve"],
        capabilityMode: "any",
      },
      {
        key: "platform-administrators",
        to: "/admin/platform/administrators",
        label: "Platform Administrators",
        capabilities: ["platform_administrators.manage"],
      },
      {
        key: "platform-detection",
        to: "/admin/platform/detection-engine",
